...
public class ListenController {
    ...
    public Listen one(@PathVariable Long history_id) {
    ...
    public Listen replaceListen(@RequestBody Listen newListen, @PathVariable Long history_id) {
        return repo.findById(history_id)
                .map(listen -> {
    ...
    public void deleteListen(@PathVariable Long history_id) {
